    ...
    <main className="min-h-screen bg-white dark:bg-[#161616] flex items-center justify-center px-6">
      <div className="max-w-lg w-full text-center">
        ...
        >
          ...
          <h1 className="text-7xl md:text-9xl font-light text-[#111111] dark:text-white tracking-tight mb-4">
            404
          </h1>
          <p className="text-xl font-light text-[#2B2B2B]/60 dark:text-white/60 mb-4">
            Página no encontrada
          </p>
          <p className="text-sm font-light text-[#2B2B2B]/40 dark:text-white/40 mb-12 max-w-sm mx-auto">
