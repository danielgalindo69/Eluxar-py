        ...
        <AnimatePresence mode="wait">
          ...
          {phase === "code" && (
            <motion.div key="form-code" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="space-y-12">
              <div className="text-center space-y-4">
                <h1 className="text-2xl font-light text-[#111111] tracking-tight uppercase tracking-[0.2em]">Verificar Código</h1>
                <p className="text-[#2B2B2B]/60 text-xs font-light max-w-sm mx-auto">
                  Hemos enviado un código seguro de 6 dígitos a <strong className="text-[#111111]">{email}</strong>.
                </p>
              </div>

              <form onSubmit={handleCodeSubmit} className="space-y-8">
                <div className="flex flex-col space-y-2">
                  <label className="text-[10px] uppercase tracking-widest font-bold text-[#2B2B2B]/40 text-center">Código de Seguridad</label>
                  <div className="relative border-b border-[#2B2B2B]/20 py-2 group focus-within:border-[#111111] transition-colors">
                    <KeyRound className="absolute right-0 top-1/2 -translate-y-1/2 text-[#2B2B2B]/20 group-focus-within:text-[#111111]" size={16} />
              ...
              <div className="text-center">
                <button onClick={() => setPhase('email')} className="text-[10px] uppercase tracking-widest font-bold text-[#2B2B2B]/40 hover:text-[#111111] transition-colors inline-flex items-center gap-2">
          ...
          {phase === "password" && (
            <motion.div key="form-password" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="space-y-12">
              <div className="text-center space-y-4">
                <h1 className="text-2xl font-light text-[#111111] tracking-tight uppercase tracking-[0.2em]">Nueva Contraseña</h1>
                <p className="text-[#2B2B2B]/40 text-[10px] uppercase tracking-[0.2em] font-bold">
              ...
              <form onSubmit={handlePasswordSubmit} className="space-y-8">
                <div className="space-y-6">
                    ...
                    <div className="flex flex-col space-y-2">
                    <label className="text-[10px] uppercase tracking-widest font-bold text-[#2B2B2B]/40">Repetir Contraseña</label>
                    <div className="relative border-b border-[#2B2B2B]/20 py-2 group focus-within:border-[#111111] transition-colors">
                        <Lock className="absolute right-0 top-1/2 -translate-y-1/2 text-[#2B2B2B]/20 group-focus-within:text-[#111111]" size={16} />
          ...
          {phase === "success" && (
            <motion.div key="success" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center space-y-8">
              ...
              <div className="space-y-4">
                <h2 className="text-2xl font-light text-[#111111] tracking-tight">¡Contraseña Recuperada!</h2>
