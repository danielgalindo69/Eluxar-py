...
import { stockAlertsAPI, StockAlert } from "../../../core/api/api";
    ...
    <div className="space-y-8">
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {alerts.map(alert => (
            <div key={alert.productId} className={`bg-white dark:bg-[#161616] border p-6 space-y-4 ${alert.severity === 'critical' ? 'border-red-400/50' : 'border-amber-400/50'}`}>
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-bold uppercase tracking-widest text-[#111111] dark:text-white">{alert.productName}</h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-[#EDEDED] dark:bg-[#111111] p-4">
                  ...
                  <p className="text-2xl font-light text-[#111111] dark:text-white">{alert.threshold}</p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-[10px] text-[#2B2B2B]/40 dark:text-white/30 mt-1">{Math.round((alert.currentStock / alert.threshold) * 100)}% del umbral</p>
              </div>
              ...
              {editingId === alert.productId ? (
                <div className="flex gap-2">
                  ...
                  <button onClick={() => handleUpdateThreshold(alert.productId)} className="bg-[#111111] dark:bg-white dark:text-[#111111] text-white px-4 py-2 text-[10px] uppercase tracking-widest font-bold">Guardar</button>
