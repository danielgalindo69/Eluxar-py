          ...
          <div className="flex items-center justify-between mb-16">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-3xl font-light text-[#111111] tracking-tight">Recomendado por IA</h2>
              </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="relative aspect-[16/9] group cursor-pointer overflow-hidden bg-[#EDEDED]">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-6">
              ...
              <Link to="/catalog" className="border-b border-white pb-1 text-[10px] uppercase tracking-widest font-bold hover:opacity-60 transition-opacity">Ver Todo</Link>
            </div>
          </div>
          <div className="relative aspect-[16/9] group cursor-pointer overflow-hidden bg-[#EDEDED]">
            <ImageWithFallback 
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-6">
              ...
              <Link to="/catalog" className="border-b border-white pb-1 text-[10px] uppercase tracking-widest font-bold hover:opacity-60 transition-opacity">Explorar</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-16">
            <Link to="/catalog" className="inline-block bg-[#111111] text-white px-10 py-4 text-[10px] uppercase tracking-widest font-bold hover:bg-[#3A4A3F] transition-colors">
      ...
      <section className="py-24 bg-[#EDEDED] px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="w-full md:w-1/2 space-y-10">
            <h3 className="text-3xl font-light text-[#111111] leading-snug">Excelencia Técnica en <br />cada Composición</h3>
            <div className="space-y-8">
              <div>
                <h4 className="text-[10px] uppercase tracking-widest font-bold text-[#3A4A3F] mb-3">Concentración Extrait</h4>
                <p className="text-sm text-[#2B2B2B]/60 font-light leading-relaxed">Nuestras fórmulas utilizan una de las concentraciones más altas permitidas en la industria para garantizar una longevidad excepcional.</p>
              </div>
              <div>
                <h4 className="text-[10px] uppercase tracking-widest font-bold text-[#3A4A3F] mb-3">Envases Sostenibles</h4>
                <p className="text-sm text-[#2B2B2B]/60 font-light leading-relaxed">Vidrio reciclado de alta densidad y cierres magnéticos diseñados para una durabilidad indefinida.</p>
              </div>
              <div>
                <h4 className="text-[10px] uppercase tracking-widest font-bold text-[#3A4A3F] mb-3">Neutralidad de Género</h4>
                <p className="text-sm text-[#2B2B2B]/60 font-light leading-relaxed">Composiciones equilibradas que eliminan las barreras tradicionales de la perfumería masculina y femenina.</p>
              </div>
            </div>
            <Link to="/catalog" className="inline-block bg-[#111111] text-white px-10 py-4 text-[10px] uppercase tracking-widest font-bold hover:bg-[#3A4A3F] transition-colors">Ver Colección</Link>
          </div>
        </div>
      </section>

      {/* Subscription Banner */}
      <section className="relative h-[40vh] bg-white flex items-center justify-center text-center px-6 border-t border-[#EDEDED]">
         <div className="max-w-3xl flex flex-col items-center">
           <h2 className="text-[#111111] text-2xl md:text-4xl font-light tracking-tight mb-8">
             Eluxar Journal
           </h2>
